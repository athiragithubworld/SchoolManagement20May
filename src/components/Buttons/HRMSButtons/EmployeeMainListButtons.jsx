...
const EmployeeMainListButtons = ({ filterData , filter }) => {
  ...
  //function to toggle filter dropdown (All, faculty)
  ...
  return (
    <div className="flex gap-5 justify-between max-md:flex-wrap">
      <span className={`${styles.f} flex gap-2`}>
        ...
        >
          <div
            className={`${styles.selectContainer} text-base h-full`}
...
export default EmployeeMainListButtons;
